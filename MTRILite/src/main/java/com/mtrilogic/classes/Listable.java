...
public final class Listable<M extends Model> {
    ...
    public void attachList(@NonNull final Observable observable){
        iterateList(new OnIterationListener<M>() {
            @Override
            public void onIteration(@NonNull M item) {
                attach(item, observable);
            }
        });
    }
    ...
    public void detachList(@NonNull final Observable observable){
        iterateList(new OnIterationListener<M>() {
            @Override
            public void onIteration(@NonNull M item) {
                detach(item, observable);
            }
        });
    }
