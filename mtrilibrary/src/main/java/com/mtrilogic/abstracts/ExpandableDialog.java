...
public abstract class ExpandableDialog<M extends Model> extends BaseDialog<M> implements ExpandableAdapterListener, ExpandableItemListener {
    ...
    public ExpandableDialog(Context context, Mappable<Model> modelMappable, OnTaskCompleteListener<M> listener) {
        super(context, listener);
        this.modelMappable = modelMappable;
    }

    protected ExpandableDialog(Context context, boolean cancelable, OnCancelListener cancelListener, Mappable<Model> modelMappable, OnTaskCompleteListener<M> listener) {
