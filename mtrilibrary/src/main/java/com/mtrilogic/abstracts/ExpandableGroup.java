...
public abstract class ExpandableGroup<M extends Model> extends Expandable<M> {
    ...
    public ExpandableGroup(Class<M> clazz, View itemView, ExpandableItemListener listener){
    ...
    public void bindModelable(Model model, int groupPosition, boolean expanded){
    ...
    protected final boolean addChild(Model child){
    ...
    protected final void detachChildList(Observable observable){
