...
public abstract class RecyclableDialog<M extends Model> extends BaseDialog<M> implements RecyclableAdapterListener, RecyclableItemListener {
    ...
    public RecyclableDialog(Context context, Listable<Model> modelListable, OnTaskCompleteListener<M> listener) {
        super(context, listener);
        this.modelListable = modelListable;
    }

    protected RecyclableDialog(Context context, boolean cancelable, OnCancelListener cancelListener, Listable<Model> modelListable, OnTaskCompleteListener<M> listener) {
